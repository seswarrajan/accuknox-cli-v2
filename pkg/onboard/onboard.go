...
func CreateClusterConfig(clusterType ClusterType, userConfigPath string, vmMode VMMode,
	...
	rmqAddr string, deploySumengine bool, registry, registryConfigPath string, insecureRegistryConnection, httpRegistryConnection, preserveUpstream bool, topicPrefix, connName, sumEngineCronTime string, tls TLS, enableHostPolicyDiscovery bool, splunk SplunkConfig) (*ClusterConfig, error) {
